...
export const ExecutionEnvironmentCapabilities = Schema.Struct({
  ...
  /** Server runs Pair Rooms (`pairRoom.dispatch`, `subscribePairRooms`). Absent
      on servers without the feature, where clients hide every Pair entry point. */
  pairRooms: Schema.optionalKey(Schema.Boolean),
